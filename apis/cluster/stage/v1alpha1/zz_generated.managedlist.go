...
// GetItems of this AccountLockdownList.
func (l *AccountLockdownList) GetItems() []resource.Managed {
...
// GetItems of this EndpointsList.
func (l *EndpointsList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
