...
type IdentificationInitParameters struct {
	...
	PasswordStageRef *v2.NamespacedReference `json:"passwordStageRef,omitempty" tf:"-"`

	// Selector for a Password in stage to populate passwordStage.
	// +kubebuilder:validation:Optional
	PasswordStageSelector *v2.NamespacedSelector `json:"passwordStageSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SourcesRefs []v2.NamespacedReference `json:"sourcesRefs,omitempty" tf:"-"`

	// Selector for a list of Oauth in source to populate sources.
	// +kubebuilder:validation:Optional
	SourcesSelector *v2.NamespacedSelector `json:"sourcesSelector,omitempty" tf:"-"`
