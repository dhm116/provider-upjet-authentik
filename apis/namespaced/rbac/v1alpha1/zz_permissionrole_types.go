...
type PermissionRoleInitParameters struct {
	...
	// Reference to a Flow in flow to populate objectId.
	// +kubebuilder:validation:Optional
	ObjectIDRef *v2.NamespacedReference `json:"objectIdRef,omitempty" tf:"-"`

	// Selector for a Flow in flow to populate objectId.
	// +kubebuilder:validation:Optional
	...
	// Reference to a Role in authentik to populate role.
	// +kubebuilder:validation:Optional
	RoleRef *v2.NamespacedReference `json:"roleRef,omitempty" tf:"-"`

	// Selector for a Role in authentik to populate role.
	// +kubebuilder:validation:Optional
