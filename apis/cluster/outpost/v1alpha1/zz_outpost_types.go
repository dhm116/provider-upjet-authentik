...
type OutpostInitParameters struct {
	...
	ProtocolProvidersRefs []v2.Reference `json:"protocolProvidersRefs,omitempty" tf:"-"`

	// Selector for a list of Proxy in provider to populate protocolProviders.
	// +kubebuilder:validation:Optional
	ProtocolProvidersSelector *v2.Selector `json:"protocolProvidersSelector,omitempty" tf:"-"`
