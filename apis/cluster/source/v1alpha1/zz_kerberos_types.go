...
type KerberosInitParameters struct {
	...
	SpnegoKeytabSecretRef *v2.SecretKeySelector `json:"spnegoKeytabSecretRef,omitempty" tf:"-"`
	...
	SyncKeytabSecretRef *v2.SecretKeySelector `json:"syncKeytabSecretRef,omitempty" tf:"-"`
	...
	SyncPasswordSecretRef *v2.SecretKeySelector `json:"syncPasswordSecretRef,omitempty" tf:"-"`
