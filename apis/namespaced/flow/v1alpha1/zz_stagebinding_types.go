...
type StageBindingInitParameters struct {
	...
	// (String)
	// +crossplane:generate:reference:type=github.com/dhm116/provider-upjet-authentik/apis/namespaced/stage/v1alpha1.Dummy
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	Stage *string `json:"stage,omitempty" tf:"stage,omitempty"`

	// Reference to a Dummy in stage to populate stage.
	// +kubebuilder:validation:Optional
	StageRef *v2.NamespacedReference `json:"stageRef,omitempty" tf:"-"`

	// Selector for a Dummy in stage to populate stage.
	// +kubebuilder:validation:Optional
	...
	// Reference to a Flow in flow to populate target.
	// +kubebuilder:validation:Optional
	TargetRef *v2.NamespacedReference `json:"targetRef,omitempty" tf:"-"`

	// Selector for a Flow in flow to populate target.
	// +kubebuilder:validation:Optional
