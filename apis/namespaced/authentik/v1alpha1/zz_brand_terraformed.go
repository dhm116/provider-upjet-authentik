...
func (tr *Brand) GetObservation() (map[string]any, error) {
...
func (tr *Brand) SetObservation(obs map[string]any) error {
...
func (tr *Brand) GetParameters() (map[string]any, error) {
...
func (tr *Brand) SetParameters(params map[string]any) error {
...
// GetInitParameters of this Brand
func (tr *Brand) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Brand
func (tr *Brand) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
