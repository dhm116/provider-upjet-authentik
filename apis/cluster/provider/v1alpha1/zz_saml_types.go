...
type SAMLInitParameters struct {
	...
	// (String) Also known as EntityID. Providing a value overrides the default issuer generated by authentik.
	// Also known as EntityID. Providing a value overrides the default issuer generated by authentik.
	IssuerOverride *string `json:"issuerOverride,omitempty" tf:"issuer_override,omitempty"`
	...
	// (Boolean) Defaults to false.
	// Defaults to `false`.
	SignLogoutResponse *bool `json:"signLogoutResponse,omitempty" tf:"sign_logout_response,omitempty"`
