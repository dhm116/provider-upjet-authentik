...
type KerberosInitParameters struct {
	...
	SpnegoKeytabSecretRef *v2.LocalSecretKeySelector `json:"spnegoKeytabSecretRef,omitempty" tf:"-"`
	...
	SyncKeytabSecretRef *v2.LocalSecretKeySelector `json:"syncKeytabSecretRef,omitempty" tf:"-"`
	...
	SyncPasswordSecretRef *v2.LocalSecretKeySelector `json:"syncPasswordSecretRef,omitempty" tf:"-"`
...
// KerberosSpec defines the desired state of Kerberos
type KerberosSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            KerberosParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider KerberosInitParameters `json:"initProvider,omitempty"`
}

// KerberosStatus defines the observed state of Kerberos.
type KerberosStatus struct {
	v2.ManagedResourceStatus `json:",inline"`
	AtProvider               KerberosObservation `json:"atProvider,omitempty"`
}
...
// Kerberos is the Schema for the Kerbeross API. <no value>
...
type Kerberos struct {
	...
	Spec   KerberosSpec   `json:"spec"`
	Status KerberosStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// KerberosList contains a list of Kerbeross
type KerberosList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []Kerberos `json:"items"`
}

// Repository type metadata.
var (
	Kerberos_Kind             = "Kerberos"
	Kerberos_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: Kerberos_Kind}.String()
	Kerberos_KindAPIVersion   = Kerberos_Kind + "." + CRDGroupVersion.String()
	Kerberos_GroupVersionKind = CRDGroupVersion.WithKind(Kerberos_Kind)
)

func init() {
	SchemeBuilder.Register(&Kerberos{}, &KerberosList{})
}
