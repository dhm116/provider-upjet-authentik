...
type AuthenticatorWebauthnInitParameters struct {
	...
	// (List of String)
	Hints []*string `json:"hints,omitempty" tf:"hints,omitempty"`
	...
	// Defaults to `true`.
	PreventDuplicateDevices *bool `json:"preventDuplicateDevices,omitempty" tf:"prevent_duplicate_devices,omitempty"`
