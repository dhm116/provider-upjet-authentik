...
type IdentificationInitParameters struct {
	...
	// (String)
	// +crossplane:generate:reference:type=github.com/dhm116/provider-authentik/apis/cluster/stage/v1alpha1.Password
	...
	// (List of String)
	// +crossplane:generate:reference:type=github.com/dhm116/provider-authentik/apis/cluster/source/v1alpha1.Oauth
