...
type AuthenticatorValidateInitParameters struct {
	...
	// Defaults to `1`.
	EmailOtpThrottlingFactor *float64 `json:"emailOtpThrottlingFactor,omitempty" tf:"email_otp_throttling_factor,omitempty"`
	...
	// (Number) Defaults to 1.
	// Defaults to `1`.
	SMSOtpThrottlingFactor *float64 `json:"smsOtpThrottlingFactor,omitempty" tf:"sms_otp_throttling_factor,omitempty"`

	// (Number) Defaults to 1.
	// Defaults to `1`.
	StaticOtpThrottlingFactor *float64 `json:"staticOtpThrottlingFactor,omitempty" tf:"static_otp_throttling_factor,omitempty"`

	// (Number) Defaults to 1.
	// Defaults to `1`.
	TotpOtpThrottlingFactor *float64 `json:"totpOtpThrottlingFactor,omitempty" tf:"totp_otp_throttling_factor,omitempty"`

	// (List of String)
	WebauthnAllowedDeviceTypes []*string `json:"webauthnAllowedDeviceTypes,omitempty" tf:"webauthn_allowed_device_types,omitempty"`

	// (List of String)
	WebauthnHints []*string `json:"webauthnHints,omitempty" tf:"webauthn_hints,omitempty"`
