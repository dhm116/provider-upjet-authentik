...
func (tr *AuthenticatorDuo) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"admin_secret_key": "adminSecretKeySecretRef", "client_secret": "clientSecretSecretRef"}
}
...
// GetInitParameters of this AuthenticatorDuo
func (tr *AuthenticatorDuo) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
