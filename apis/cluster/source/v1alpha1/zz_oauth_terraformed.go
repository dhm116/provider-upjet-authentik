...
// GetInitParameters of this Oauth
func (tr *Oauth) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Oauth
func (tr *Oauth) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
