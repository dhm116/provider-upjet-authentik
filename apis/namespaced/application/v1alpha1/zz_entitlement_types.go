...
type EntitlementInitParameters struct {
	...
	// Reference to a Application in application to populate application.
	// +kubebuilder:validation:Optional
	ApplicationRef *v2.NamespacedReference `json:"applicationRef,omitempty" tf:"-"`

	// Selector for a Application in application to populate application.
	// +kubebuilder:validation:Optional
	ApplicationSelector *v2.NamespacedSelector `json:"applicationSelector,omitempty" tf:"-"`
