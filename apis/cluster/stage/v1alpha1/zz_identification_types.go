...
type IdentificationInitParameters struct {
	...
	// (String)
	// +crossplane:generate:reference:type=github.com/dhm116/provider-upjet-authentik/apis/cluster/stage/v1alpha1.Password
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	PasswordStage *string `json:"passwordStage,omitempty" tf:"password_stage,omitempty"`

	// Reference to a Password in stage to populate passwordStage.
	// +kubebuilder:validation:Optional
	PasswordStageRef *v2.Reference `json:"passwordStageRef,omitempty" tf:"-"`

	// Selector for a Password in stage to populate passwordStage.
	// +kubebuilder:validation:Optional
	PasswordStageSelector *v2.Selector `json:"passwordStageSelector,omitempty" tf:"-"`
	...
	// (List of String)
	// +crossplane:generate:reference:type=github.com/dhm116/provider-upjet-authentik/apis/cluster/source/v1alpha1.Oauth
	...
	// References to Oauth in source to populate sources.
	// +kubebuilder:validation:Optional
	SourcesRefs []v2.Reference `json:"sourcesRefs,omitempty" tf:"-"`

	// Selector for a list of Oauth in source to populate sources.
	// +kubebuilder:validation:Optional
	SourcesSelector *v2.Selector `json:"sourcesSelector,omitempty" tf:"-"`
