...
type OutpostInitParameters struct {
	...
	// References to Proxy in provider to populate protocolProviders.
	// +kubebuilder:validation:Optional
	ProtocolProvidersRefs []v2.NamespacedReference `json:"protocolProvidersRefs,omitempty" tf:"-"`

	// Selector for a list of Proxy in provider to populate protocolProviders.
	// +kubebuilder:validation:Optional
	ProtocolProvidersSelector *v2.NamespacedSelector `json:"protocolProvidersSelector,omitempty" tf:"-"`
